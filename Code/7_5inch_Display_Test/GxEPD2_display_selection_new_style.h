...
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=5*/ 2, /*DC=*/ 25, /*RST=*/ 17, /*BUSY=*/ 26));
#else
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=5*/ SPI_EPD_CS, /*DC=*/ SPI_EPD_DC, /*RST=*/ SPI_EPD_RST, /*BUSY=*/ SPI_EPD_BUSY));
#endif
#else // GxEPD2_1248
